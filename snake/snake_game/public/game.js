class	Game
{
	...
	// creer une boulette au hasard et verifie si elle ne se trouve pas
	// sur le serpent sinon recommence
	...
	// initialise la position de la boulette et la tete du serpent au debut du jeu
	init() {
